...
class BluetoothApp1 extends StatefulWidget {
  @override
  _BluetoothApp1State createState() => _BluetoothApp1State();
}

class _BluetoothApp1State extends State<BluetoothApp1> {
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(
                          "NOTE: If you cannot find the gun by going to the bluetooth settings",
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                            color: Colors.red,
