...
class Join3teamRescUntilStart extends StatefulWidget {
  @override
  _Join3teamRescUntilStartState createState() =>
      _Join3teamRescUntilStartState();
}

final FirebaseAuth _auth = FirebaseAuth.instance;

class _Join3teamRescUntilStartState extends State<Join3teamRescUntilStart> {
  //print(Match.mid);
